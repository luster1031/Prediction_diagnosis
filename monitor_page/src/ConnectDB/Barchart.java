...
public class Barchart {
	...
	public JFreeChart getPieChart(){
        ...
        // 데이터 입력 ( 값, 그래프 종류, 카테고리 )
        // 그래프 1       
    	factory=Integer.parseInt(data.getFactory_sug().replace("일", ""));
    	System.out.println("제조사 추천 "+ factory);
        dataset1.addValue(factory, "제조사 추천 교체 주기", data.getPart_name());

        // 그래프 2       
        factory=Integer.parseInt(data.getActual_change().replace("일", ""));
        dataset1.addValue(factory, "실제 교체 주기", data.getPart_name());
        // 그래프 3       

        dataset2.addValue(data.getHow_many(), "고장 횟수", data.getPart_name());
    	}
        // 렌더링 생성 및 세팅
...
//        renderer.setSeriesPaint(0, new GradientPaint(1.0f, 1.0f, Color.white, 0.0f, 0.0f, Color.blue));
        ...
        renderer2.setBaseFillPaint(Color.WHITE);	//동그라미 
        ...
        renderer2.setSeriesStroke(0,new BasicStroke(		//직선
        ...
        plot.setDomainAxis(0, new CategoryAxis());              // X축 종류 설정
        plot.setDomainAxis(1, new CategoryAxis());              // X축 종류 설정
       ...
       chart.setTitle("제조사 추천 교체 주기 및 실제 교체 주기 & 고장 횟수"); // 차트 타이틀
